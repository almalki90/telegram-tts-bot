...
def generate_story_and_title(excerpt):
    ...
    2. اسرد القصة كقطعة واحدة متصلة. **لا تكتب أي عناوين فرعية على الإطلاق**. تجنب تماماً استخدام كلمات مثل: (بداية القصة، تصاعد الأحداث، ذروة الحدث، النهاية، الخاتمة، العبرة).
    3. **تجنب ذكر أي عبرة أو دروس مستفادة**. فقط اسرد الحدث التاريخي كما حدث من مصدره وتوقف بمجرد انتهاء الحدث.
    4. ضع التشكيل فقط على الكلمات الصعبة.
    5. لا تختصر! اكتب سردًا دسمًا ومليئًا بالتفاصيل الموجودة في النص، وتجنب أي مقدمات ترحيبية أو تمهيدية.
